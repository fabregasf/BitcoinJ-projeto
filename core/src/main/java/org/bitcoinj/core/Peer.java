...
public class Peer extends PeerSocketHandler {
    ...
    // Once the tx is downloaded (by some peer), the TransactionTest object that is created will have a reference to
    // the confidence object held inside it, and it's then up to the event listeners that receive the TransactionTest
    ...
    protected void endFilteredBlock(FilteredBlock m) {
        ...
        try {
            ...
            // The FilteredBlock m here contains a list of hashes, and may contain TransactionTest objects for a subset
    ...
    @SuppressWarnings("unchecked")
    // The 'unchecked conversion' warning being suppressed here comes from the sendSingleGetData() formally returning
    // ListenableFuture instead of ListenableFuture<TransactionTest>. This is okay as sendSingleGetData() actually returns
    // ListenableFuture<TransactionTest> in this context. Note that sendSingleGetData() is also used for Blocks.
