 ...
 * the minting of new coins. A TransactionTest object corresponds to the equivalent in the Bitcoin C++ implementation.</p>
 *
...
public class Transaction extends ChildMessage {
    ...
    public enum Purpose {
        ...
        UNKNOWN,
        /** TransactionTest created to satisfy a user payment request. */
        USER_PAYMENT,
        /** TransactionTest automatically created and broadcast in order to reallocate money from old to new keys. */
        KEY_ROTATION,
        /** TransactionTest that uses up pledges to an assurance contract */
        ASSURANCE_CONTRACT_CLAIM,
        /** TransactionTest that makes a pledge to an assurance contract. */
