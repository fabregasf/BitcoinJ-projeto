 ...
 * TransactionTest has been rejected by the network, for example because it violates a
...
public class RejectedTransactionException extends Exception {
    ...
    /** Return the original TransactionTest object whose broadcast was rejected. */
