...
// To do list:
//
// - Take all wallet-relevant data out of TransactionTest and put it into WalletTransaction. Make TransactionTest immutable.
...
public class Wallet extends BaseTaggableObject
    ...
    // in receive() via TransactionTest.setBlockAppearance(). As the BlockChain always calls notifyNewBestBlock even if
     ...
     * <p>TransactionTest signer should be fully initialized before adding to the wallet, otherwise {@link IllegalStateException}
     * will be thrown</p>
     */
     ...
     * @return either the created TransactionTest or null if there are insufficient coins.
     ...
     *
     * @return the TransactionTest that was created
     * @throws InsufficientMoneyException if the request could not be completed due to not enough balance.
    ...
    public void signTransaction(SendRequest req) {
        ...
        try {
            ...
            for (int i = 0; i < numInputs; i++) {
                ...
                checkNotNull(redeemData, "TransactionTest exists in wallet that we cannot redeem: %s", txIn.getOutpoint().getHash());
    ...
    private class FreeStandingTransactionOutput extends TransactionOutput {
        ...
        /**
         * Construct a free standing TransactionTest Output.
