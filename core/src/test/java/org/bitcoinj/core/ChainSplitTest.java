...
public class ChainSplitTest {
    ...
    public void txConfidenceLevels() throws Exception {
        ...
        // TransactionTest 1 (in block b2) is now on a side chain, so it goes pending (not see in chain).
    ...
    public void coinbaseDeath() throws Exception {
        ...
        // TransactionTest 1 (in block b2) is now on a side chain and should have confidence type of dead and be in
        // the dead pool only.
